import { IonList, IonItem, IonLabel, IonButton, IonAvatar, IonBadge } from '@ionic/react';
...
const FriendsList: React.FC = () => {
  ...
  return (
    ...
    :<h1 className="ion-text-center">Looks like you need some bathroom buddies!</h1>}
    </>
  )
}
